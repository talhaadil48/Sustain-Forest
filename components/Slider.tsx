...
export default function IntegratedAccordion() {
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <div
          className={`relative z-10 px-6 py-16 max-w-5xl text-center mx-auto text-white mb-9 ${
            isVisible ? "animate-fade-in-up" : "opacity-0"
          }`}
        >
          <h1 className="text-5xl sm:text-4xl text-center font-bold mb-6 text-green-100">
            {t("about_h")}
          </h1>
          <p
            className={`text-base sm:text-lg leading-relaxed mb-4 drop-shadow-md ${
          ...
          <p
            className={`text-base sm:text-lg leading-relaxed drop-shadow-md ${
          ...
          <SpeakText file="about_combined" desgined={false}/>
          </div>
          
        </div>
        <ImageMap onSelect={handleMapPointSelect} />

        <div ref={accordionRef} className="relative z-10 w-full">
              ...
              {accordionData.map((item, index) => (
                <div
                  ...
                  className={`relative cursor-pointer transition-all duration-700 ease-out rounded-xl overflow-hidden ${
                    activeItem === item.id
                      ? "flex-[4] shadow-2xl shadow-black/30"
          ...
          <div className="md:hidden px-4 space-y-6">
            {accordionData.map((item, index) => (
              <div
                ...
                onTouchEnd={() =>
                  setTimeout(() => setHoveredMobileItem(null), 3000)
                }
