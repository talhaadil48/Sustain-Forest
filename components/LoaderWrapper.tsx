        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative">
              ...
              />
              <Leaf
                className="absolute -top-1 -left-3 w-3 h-3 text-emerald-500 animate-bounce"
                style={{ animationDelay: "0.5s" }}
              />
              <Leaf
                className="absolute top-2 right-1 w-3 h-3 text-green-600 animate-bounce"
                style={{ animationDelay: "1s" }}
              />
            </div>
          </div>
          ...
          <div className="mt-6 flex items-center space-x-2 text-emerald-600 text-sm">
            <div className="flex space-x-1">
              ...
              <div className="w-1 h-3 bg-emerald-600 rounded animate-pulse" style={{ animationDelay: "0.2s" }} />
              <div className="w-1 h-5 bg-green-700 rounded animate-pulse" style={{ animationDelay: "0.3s" }} />
              <div className="w-1 h-4 bg-emerald-800 rounded animate-pulse" style={{ animationDelay: "0.4s" }} />
            </div>
            <span className="font-medium">Nature sounds loading...</span>
          </div>
        </div>
