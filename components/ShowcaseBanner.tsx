...
export default function ShowcaseBanner({ descriptions, images , title ,titleDesription}: ShowcaseBannerProps) {
  ...
  const blockTitles = ["How We Made It", "About It", "Impact on Environment"]
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      >
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">{title}</h1>
        ...
        <div className="max-w-6xl mx-auto space-y-16 md:space-y-24">
          {blockTitles.map((title, index) => (
            <div
              ...
              className={`opacity-0 transform translate-y-8 transition-all duration-800 delay-${index * 200}`}
            >
              <div
