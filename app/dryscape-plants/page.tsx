  ...
  return (
    <main>
      <ShowcaseBanner
        ...
        images={[
          "/images/plant1.webp?height=400&width=600",
          "/images/plant2.webp?height=900&width=400",
          "/images/plant3.webp?height=400&width=600",
          "/images/plant2.webp?height=400&width=600",
        ]}
        descriptions={[
